  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-gray-400 text-sm mb-4 h-10 overflow-hidden text-ellipsis">{challenge.description}</p>
        <div className="flex justify-end items-center">
          <span className="text-md font-bold text-blue-400 px-3 py-1 bg-blue-500/20 rounded-full">
